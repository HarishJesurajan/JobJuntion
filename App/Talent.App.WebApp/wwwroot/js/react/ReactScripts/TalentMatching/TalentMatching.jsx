...
export default class TalentMatching extends React.Component {
    ...
    //loadJobs(data) { // url: 'https://jobjunctiontalent.azurewebsites.net/listing/listing/getEmployerJobs',
        
    //loadSelectedJob(data) url: 'https://jobjunctiontalent.azurewebsites.net/listing/listing/getJobForTalentMatching',

    //loadTalentList()  url: 'https://jobjunctionprofile.azurewebsites.net/profile/profile/getTalentList',

    //loadTalentFilterList() //url: 'https://jobjunctionprofile.azurewebsites.net/profile/profile/getTalentListFilter',

    //loadEmployerFilterList() //url: 'https://jobjunctionprofile.azurewebsites.net/profile/profile/getEmployerListFilter',


    // loadEmployerList() // url: 'https://jobjunctionprofile.azurewebsites.net/profile/profile/getEmployerList',
    //loadSuggestionList   url: 'https://jobjunctionprofile.azurewebsites.net/profile/profile/getSuggestionList',

   // saveCompanyTalents()   url: 'https://jobjunctionprofile.azurewebsites.net/profile/profile/addTalentSuggestions',
     

    //saveJobTalents()    url: 'https://jobjunctionprofile.azurewebsites.net/profile/profile/addTalentSuggestions',
