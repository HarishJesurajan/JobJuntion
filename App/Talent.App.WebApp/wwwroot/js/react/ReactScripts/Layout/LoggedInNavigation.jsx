...
export class LoggedInNavigation extends React.Component {
    ...
    isUserAuthenticated() {
        ...
        $.ajax({
            url: 'https://jobjunctionprofile.azurewebsites.net/profile/profile/isUserAuthenticated',
            headers: {
    ...
    render() {
        ...
        const recruitmentData = [
            {
                label: "View Job Hunter Feed",
                href: "/Feed",
                type: "link"
            },
            {
                label: 'View Job Hunter Watchlist',
                href: '/Watchlist',
                type: 'link'
            },
            {
