...
export default class ManageClient extends React.Component {
    ...
    // loadData url: 'https://jobjunctionprofile.azurewebsites.net/profile/profile/getClientList',
    //deleteClient  url: 'https://jobjunctionidentity.azurewebsites.net/authentication/authentication/deactivateClientAccount?id=' + clientId,
