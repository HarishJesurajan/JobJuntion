...
namespace Talent.Services.Profile.Domain.Contracts
{
    public interface IProfileService
    {
        ...
        Task<bool> DeleteLanguage(string languageId, string talentId);
        Task<bool> DeleteSkill(string SkillId, string talentId);
        Task<bool> DeleteExperience(string experienceId, string talentId);
    }
}
